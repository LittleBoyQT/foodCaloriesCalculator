...
namespace CaloriesCalculatorVer2
{
    public partial class StatisticForm : Form
    {
        ...
        public DTO_DailyData DailySets { get => dailySets; set => dailySets = value; }
        ...
        private void ShowSetByDate(DateTime date)
        {
            ...
            if (todaySet != null)
            {
                float total = float.Parse(todaySet.CrossirantsValue) + float.Parse(todaySet.BurnedCaloriesValue);
